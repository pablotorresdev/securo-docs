...
|---------|-------------|--------|
| `templates/proveedores/list-proveedores.html` | Listado con DataTables | 178 |
| `templates/proveedores/add-proveedor.html` | Formulario de alta | 145 |
| `templates/proveedores/edit-proveedor.html` | Formulario de edicion | 146 |

### Backend
| Archivo | Descripcion | Lineas |
|---------|-------------|--------|
| `controller/maestro/ABMProveedoresController.java` | Controlador | 125 |
| `service/maestro/ProveedorService.java` | Servicio | 39 |
| `repository/maestro/ProveedorRepository.java` | Repositorio | 33 |
| `entity/maestro/Proveedor.java` | Entidad | 61 |

### Tests
| Archivo | Descripcion | Lineas |
|---------|-------------|--------|
| `test/controller/maestro/ABMProveedoresControllerTest.java` | Tests unitarios | 272 |

### Total: 999 lineas de codigo
