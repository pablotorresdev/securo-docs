...
**Referencia:** `PermisosCasoUsoEnum.CU42_CONFIGURACION_SISTEMA` (linea 161-165)
...
|---------|-------------|--------|
| `templates/admin/configuracion.html` | Listado y formularios inline | 327 |

### Backend
| Archivo | Descripcion | Lineas |
|---------|-------------|--------|
| `controller/maestro/ConfiguracionController.java` | Controlador | 120 |
| `service/ConfiguracionService.java` | Servicio con cache y validacion | 622 |
| `entity/maestro/Configuracion.java` | Entidad JPA | 215 |
| `repository/maestro/ConfiguracionRepository.java` | Repositorio Spring Data | 118 |
| `config/ConfiguracionDataInitializer.java` | Inicializador de datos seed | 248 |
| `enums/TipoConfiguracion.java` | Enum de tipos de dato | 18 |

### Tests
| Archivo | Descripcion | Lineas |
|---------|-------------|--------|
| `service/ConfiguracionServiceTest.java` | Tests del servicio | 955 |
