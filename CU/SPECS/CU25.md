...
**Identificador Interno:** `CU25_RETIRO_MERCADO`
...
| Archivo | Descripcion |
|---------|-------------|
| `templates/ventas/recall/retiro-mercado.html` | Formulario |
| `templates/ventas/recall/retiro-mercado-confirm.html` | Confirmacion |
| `templates/ventas/recall/retiro-mercado-ok.html` | Exito |

### Backend
| Archivo | Descripcion |
|---------|-------------|
| `controller/cu/AltaRetiroMercadoController.java` | Controlador |
| `service/cu/ModifRetiroMercadoService.java` | Servicio coordinador |
| `service/cu/AltaRecallService.java` | Servicio ALTA recall |
| `service/cu/ModificacionRecallService.java` | Servicio MODIF recall |
| `service/cu/AbstractCuService.java` | Clase base |

### Tests
| Archivo | Descripcion |
|---------|-------------|
| `test/service/cu/ModifRetiroMercadoServiceTest.java` | Test coordinador |
| `test/service/cu/AltaRecallServiceTest.java` | Test ALTA |
| `test/service/cu/ModificacionRecallServiceTest.java` | Test MODIF |
...
El endpoint GET tiene `@PreAuthorize` pero los POST no. La seguridad se aplica a nivel URL via SecurityConfig usando `PermisosCasoUsoEnum.CU25_RETIRO_MERCADO`.
...
El CU25 utiliza una arquitectura de tres servicios:
...
1. **Establecer contexto de auditoria:** "CU25_RETIRO_MERCADO"
...
- **motivoDelCambio:** Formateado con prefijo `[CU25]`
...
- **Contexto de caso de uso:** "CU25_RETIRO_MERCADO"
- **Prefijo de CU:** `[CU25]`
...
- **Inicio:** `[CU25] Iniciando retiro de mercado (recall) - Usuario: {}, Lote: {}, MovimientoOrigen: {}`
- **Completado:** `[CU25] Retiro de mercado completado - LotesAfectados: {}`

**AltaRecallService:**
- **Inicio:** `[CU25-ALTA] Iniciando creacion lote recall - Usuario: {}, LoteOrigen: {}`
- **Completado:** `[CU25-ALTA] Lote recall creado - LoteRecall: {}, Cantidad: {}`

**ModificacionRecallService:**
- **Inicio:** `[CU25-MODIF] Iniciando modificacion estado a RECALL - Usuario: {}, Lote: {}`
- **Completado:** `[CU25-MODIF] Lote modificado a RECALL - Lote: {}, Estado: {}`
...
- **Archivo:** `ModifRetiroMercadoService.java`
