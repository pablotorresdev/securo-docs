...
**Configuracion de seguridad:** Controlado via `SecurityConfig.java` usando `PermisosCasoUsoEnum.CU41_ABM_PRODUCTOS`
...
| Archivo | Descripcion |
|---------|-------------|
| `templates/productos/list-productos.html` | Listado con DataTable |
| `templates/productos/add-producto.html` | Formulario de alta |
| `templates/productos/edit-producto.html` | Formulario de edicion |

### Backend
| Archivo | Descripcion |
|---------|-------------|
| `controller/maestro/ABMProductosController.java` | Controlador ABM |
| `service/maestro/ProductoService.java` | Servicio de negocio |
| `repository/maestro/ProductoRepository.java` | Repositorio JPA |
| `entity/maestro/Producto.java` | Entidad JPA |

### Enums
| Archivo | Uso en CU41 |
|---------|-------------|
| `enums/TipoProductoEnum.java` | 10 tipos de producto |
...
| Archivo | Descripcion |
|---------|-------------|
| `controller/maestro/ABMProductosControllerTest.java` | Tests del controller |
...
La entidad `Producto` esta marcada con `@Audited`:
```java
@Audited
