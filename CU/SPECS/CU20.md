...
**Nota:** El trazado de lotes NO se realiza en este CU. Se hace posteriormente con CU21.
...
| Archivo | Descripcion |
|---------|-------------|
| `templates/produccion/alta/ingreso-produccion.html` | Formulario principal |
| `templates/produccion/alta/ingreso-produccion-confirm.html` | Pantalla confirmacion |
| `templates/produccion/alta/ingreso-produccion-ok.html` | Pantalla exito |

### Backend
| Archivo | Descripcion |
|---------|-------------|
| `controller/cu/AltaIngresoProduccionController.java` | Controlador |
| `service/cu/AltaIngresoProduccionService.java` | Servicio de negocio |
...
|-------|------------------|
| `{codigoProducto}_{sufijo}` no existe en BD | "El código de lote 'XXX' ya existe en el sistema" |
