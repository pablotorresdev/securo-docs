...
**Referencia:** `PermisosCasoUsoEnum.CU43_ABM_USUARIOS` (linea 166-170)
...
|---------|-------------|--------|
| `templates/users/list-users.html` | Listado con DataTable | 216 |
| `templates/users/add-user.html` | Formulario alta | 113 |
| `templates/users/edit-user.html` | Formulario edicion | 137 |

### Backend
| Archivo | Descripcion | Lineas |
|---------|-------------|--------|
| `controller/maestro/ABMUsersController.java` | Controlador ABM | 282 |
| `service/PasswordValidator.java` | Validador de contrasenas | 171 |
| `service/SecurityContextService.java` | Obtener usuario actual | - |

### Entidades
| Archivo | Descripcion | Lineas |
|---------|-------------|--------|
| `entity/maestro/User.java` | Entidad Usuario | 197 |
| `entity/maestro/Role.java` | Entidad Rol | 79 |
...
| Archivo | Descripcion | Lineas |
|---------|-------------|--------|
| `controller/ABMUsersControllerTest.java` | Tests del controlador | 676 |
...
| CU26 | Verifica jerarquia de roles para autorizar reverso |
